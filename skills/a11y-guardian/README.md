...
import { ContrastChecker, getContrastRatio } from './src/contrast.js';
import { WCAGRules, WCAGLevel } from './src/wcag-rules.js';
...
```bash
npm test -- skills/a11y-guardian/tests/
```
...
⚠️  [warning] Heading Hierarchy (1 issue)
